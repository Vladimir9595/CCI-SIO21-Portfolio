...
class adminProfile extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'admin:profil {id}';
     ...
     * @var string
     */
    protected $description = 'Search the admin profil';
    ...
    public function handle()
    {
        ...
        if (User::find($this->argument()['id'])) {
            ...
            echo "\n  ";
            echo "   Username => \e[1;33m " . $user->name . " \e[0m\n  ";
            echo "      Email => \e[1;33m " . $user->email . " \e[0m\n  ";
            echo "Email Verfied => \e[1;33m " . $user->email_verified_at . " \e[0m\n  ";
            echo "   Password => \e[1;33m " . $user->password . " \e[0m\n  ";
            echo "  Created at => \e[1;33m " . $user->created_at . " \e[0m\n ";
            echo "   Updated at => \e[1;33m " . $user->updated_at . " \e[0m\n ";
            echo "\n";
        } else {
